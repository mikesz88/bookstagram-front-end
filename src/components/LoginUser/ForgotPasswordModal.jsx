...
const ForgotPasswordModal = ({ form, closeParentModal }) => {
  ...
  const onFinish = (values) => {
    ...
    authService
      .verifyForgotPassword(email, forgotPasswordAnswer)
      .then((res) => {
    ...
    <StyledFormWrapper>
      ...
      >
        ...
        <Form.Item style={{ marginTop: '1rem' }}>
          {forgotQuestion ? (
            <StyledLoginButton size="large" htmlType="submit">
              Submit
            </StyledLoginButton>
          ) : (
            ''
  ...
  return (
    <>
      <StyledForgetModalDiv>
        ...
        />
        <StyledLoginButton size="large" onClick={handleQuestion}>
          Find Question
        </StyledLoginButton>
      </StyledForgetModalDiv>
      ...
      <Modal
        ...
        footer={[
          <Button key="close" type="primary" onClick={closeModals}>
            Close
          </Button>,
        ]}
      >
